...
- Heavy cream / cream sauce / béchamel / alfredo / stroganoff / white sauce → Miso Homemade Cream Sauce. Base: 12 oz silken tofu (drains smooth, neutral flavor, real protein), 1 tbsp white miso, ½ tsp Dijon, ¼ tsp garlic powder, 2–3 tbsp vegetable broth added one tbsp at a time, 1 tsp lemon juice, ¼ tsp salt. Blend on high 60–90 seconds until completely smooth and silky; add broth until it pours like heavy cream. Substitutes 1:1. Refrigerates up to 3 days. Emit as a sub-recipe.
