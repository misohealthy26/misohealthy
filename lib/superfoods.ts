...
export const SUPERFOODS: SuperfoodEntry[] = [
  {
    id: "ground-flax",
    name: "Ground flax",
    goals: ["heart health", "pre-diabetes", "gut health", "brain health", "menopause / perimenopause"],
  ...
  },
  {
    id: "chia",
    name: "Chia seeds",
    goals: ["pre-diabetes", "gut health", "brain health", "weight loss"],
  ...
  },
  {
    id: "hemp-seeds",
    name: "Hemp seeds",
    goals: ["heart health", "brain health", "weight loss"],
  ...
  },
  {
    id: "turmeric",
    name: "Turmeric",
    goals: ["brain health", "cancer prevention"],
  ...
  },
  {
    id: "ginger",
    name: "Fresh ginger",
    goals: ["gut health", "cancer prevention"],
  ...
  },
  {
    id: "pumpkin-seeds",
    name: "Pumpkin seeds",
    goals: ["heart health", "menopause / perimenopause"],
  ...
  },
  {
    ...
    goals: ["heart health", "cancer prevention"],
